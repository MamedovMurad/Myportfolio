        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<string>(maxLength: 50, nullable: true),
                    Photo = table.Column<string>(maxLength: 50, nullable: false),
                    PhortfolioLevelId = table.Column<int>(nullable: false),
                    PortfolioLevelId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<string>(maxLength: 50, nullable: true),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    PhortfolioPhotoId = table.Column<int>(nullable: false),
                    EndPoint = table.Column<string>(maxLength: 50, nullable: false),
                    PortfolioPhotoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
